...
class LeaguePlayerSeeder extends Seeder
{
    ...
    public function run(): void
    {
        collect([
            ...
            ['name' => 'Andrei', 'email' => 'player2@fifa.local', 'pin' => '2222', 'emoji' => '⚡', 'color' => '#3b82f6', 'role' => 'player'],
            ['name' => 'Botica', 'email' => 'player3@fifa.local', 'pin' => '3333', 'emoji' => '🔥', 'color' => '#f97316', 'role' => 'player'],
            ['name' => 'Ali', 'email' => 'player4@fifa.local', 'pin' => '4444', 'emoji' => '🚀', 'color' => '#a855f7', 'role' => 'player'],
