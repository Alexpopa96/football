...
<template>
    <LeagueLayout title="Cupă nouă">
        <div class="mx-auto max-w-2xl">
            ...
            <p class="mb-2 text-slate-400">Dă-i un nume și alege exact 4 jucători.</p>
            <p class="mb-8 text-xs text-slate-500">Ordinea contează: primii doi aleși se întâlnesc în prima semifinală, ceilalți doi în a doua.</p>
